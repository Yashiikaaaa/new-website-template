...
export default function LocationMap() {
  ...
  const locationData: Record<string, Array<{ name: string; distance: string }>> = {
    hospital: [
      { name: "Manipal Hospital", distance: "12 km" },
      { name: "Columbia Asia Hospital", distance: "15 km" },
      { name: "Sagar Hospital", distance: "18 km" },
      { name: "Narayana Health City", distance: "20 km" },
    ],
    schools: [
      { name: "Delhi Public School", distance: "8 km" },
      { name: "Ryan International School", distance: "10 km" },
      { name: "Greenwood High", distance: "12 km" },
      { name: "The International School", distance: "14 km" },
    ],
    connectivity: [
      { name: "Kempegowda International Airport", distance: "25 km" },
      { name: "Bangalore City Railway Station", distance: "35 km" },
      { name: "Yeswanthpur Metro Station", distance: "22 km" },
      { name: "NH-44 Highway", distance: "5 km" },
    ],
    entertainment: [
      { name: "Lumbini Gardens", distance: "18 km" },
      { name: "Wonderla Amusement Park", distance: "30 km" },
      { name: "Elements Mall", distance: "20 km" },
      { name: "Orion Mall", distance: "25 km" },
    ],
  }
