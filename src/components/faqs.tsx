  ...
  const faqs = [
    {
      ...
      answer:
        "The possession of the project is expected by [Month, Year].",
    },
    {
      question: "What is the location of the project?",
      answer:
        "The project is located at [Exact Location/Area, City, State]. It offers excellent connectivity to major landmarks such as [Nearby Highway, Metro, Airport, or Commercial Hubs].",
    },
    {
