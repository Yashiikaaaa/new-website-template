...
export default function EnquiryModal({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      campaign: true,
      projectId: "",
      projectName: "Godrej Plots Doddaballapur",
      currentAgent: "Rahul",
      utmDetails: {
    ...
    try {
      ...
      setAlert(
        <div className="p-3 bg-green-100 text-green-800 rounded flex items-center justify-between">
          <span>We received your info. Expect a response soon!</span>
          <button
      ...
      setAlert(
        <div className="p-3 bg-red-100 text-red-800 rounded flex items-center justify-between">
          ...
          <button
            onClick={() => setAlert(null)}
            className="ml-3 text-sm text-red-700 underline"
          >
            Close
          </button>
        </div>
